...
PHRASE_TRANSLATIONS = [
    ...
    ("Powder coated aluminium", "aluminio con recubrimiento en polvo"),
    ("Powder coated aluminum", "aluminio con recubrimiento en polvo"),
    ("sling dining armchair with loose seat cushion, full aluminium legs", "silla de comedor con brazos de tejido tensado, cojin de asiento suelto y patas de aluminio"),
    ("Meridienne Left short arm with straps full aluminium legs", "meridiana con descansabrazos corto izquierdo, correas y patas de aluminio"),
    ("EXTENSION MODULE SINGLE, W/SPRING, VERSION", "modulo individual de extension con resorte, version"),
    ("2-seat left arm module with rope", "modulo izquierdo de dos plazas con descansabrazos y cuerda"),
    ("barstool with back Seat and back with rope", "banco alto con asiento y respaldo de cuerda"),
    ("Rectangular Coffee Table", "mesa de apoyo rectangular"),
    ("dining armchair with rope", "silla de comedor con brazos y cuerda"),
    ("LOUNGE ARMCHAIR WITH STRAP", "sillon de descanso con correa"),
    ("Alu in teaklook", "aluminio con apariencia de teca"),
    ("with ceramic top", "con cubierta de ceramica"),
    ("Ceramic Top", "cubierta de ceramica"),
    ("Top: Ceramic", "cubierta: ceramica"),
    ("Coffee Table", "mesa de apoyo"),
    ("Fixed High-leg desk, steel Legs in two sides", "mesa alta fija con patas de acero a ambos lados"),
    ("Straight manager desk with cabinet, a side cabinet on one side, steel legs on the other", "escritorio gerencial recto con gabinete lateral y patas de acero en el lado opuesto"),
    ("Square Tea Table with Square Steel tube base", "mesa de te cuadrada con base de tubo de acero cuadrado"),
    ("middle part in front Backrest and inside part of the armrest use molded foam", "zona central del respaldo frontal y parte interior del descansabrazos con espuma moldeada"),
    ("seat cushion with individually wrapped springs", "cojin del asiento con resortes embolsados individualmente"),
    ("black screen printing on all four sides", "serigrafia negra en los cuatro lados"),
    ("made of high-quality cold-rolled steelin surface", "fabricado con superficie de acero laminado en frio de alta calidad"),
    ("adopt high resilience foam in cushion and other areas", "cojin y otras zonas con espuma de alta resiliencia"),
    ("the entire sofa uses PU synthetic leather", "el sofa completo usa piel sintetica de PU"),
    ("Non-wood Color Configuration", "configuracion sin color madera"),
    ("No wood veneer used", "sin chapa de madera"),
    ("Wood-color configuration", "configuracion color madera"),
    ("Underside of the tabletop", "cara inferior de la cubierta"),
    ("scientific veneer", "chapa de madera reconstituida"),
    ("Main components", "componentes principales"),
    ("V-shaped steel legs", "patas de acero en forma de V"),
    ("Desk Legs", "patas de escritorio"),
    ("wall thickness", "espesor de pared"),
    ("in surface", "en la superficie"),
    ("Adjustable, made of ABS + premium steel", "ajustables, fabricados en ABS y acero de alta calidad"),
    ("Goal post leg in steel", "patas de acero tipo marco"),
    ("Rectangular meeting table with panel legs", "mesa de juntas rectangular con patas de panel"),
    ("laser ABS edge banding strips", "cantos laser de ABS"),
    ("bottom entry, top exit for side cabinet", "entrada inferior y salida superior en el gabinete lateral"),
    ("Leg Frame", "estructura de patas"),
    ("main body uses", "el cuerpo principal usa"),
    ("ordinary front lock", "cerradura frontal estandar"),
    ("Fixed three-drawer cabinet", "archivero fijo de tres cajones"),
    ("fixed PA armrests", "descansabrazos fijos de PA"),
    ("PP + 20% fiberglass", "PP con 20% de fibra de vidrio"),
    ("electroplated surface", "superficie electrochapada"),
    ("Fixed podium", "podio fijo"),
    ("Podium Support", "soporte del podio"),
    ("Podium Outside Panel", "panel exterior del podio"),
    ("Podium Steel Foot", "pie de acero del podio"),
    ("Spring Bag", "nucleo de resortes"),
    ("good breathability", "buena ventilacion"),
    ("main materials use", "los materiales principales usan"),
    ("Sofa Support Parts", "componentes de soporte del sofa"),
    ("steel pivot", "pivote de acero"),
    ("360 degree rotation", "giro de 360 grados"),
    ("steel base legs", "patas con base de acero"),
    ("dry rubbing color fastness", "solidez del color al frote en seco"),
    ("with no surface breakage", "sin roturas en la superficie"),
    ("natural rubberwood Sofa Legs", "patas de sofa de madera de caucho natural"),
    ("natural beech wood Sofa Legs", "patas de sofa de madera de haya natural"),
    ("with welded steel frame", "con estructura de acero soldada"),
    ("Steel Frame", "estructura de acero"),
    ("rectangular steel tube", "tubo rectangular de acero"),
    ("Side Panel/Top Panel", "panel lateral/panel superior"),
    ("Internal sound-absorbing cotton", "algodon absorbente acustico interior"),
    ("polyester fiber board", "tablero de fibra de poliester"),
    ("flocked felt", "fieltro flocado"),
    ("combined into a", "combinados en un"),
    ("inner panel", "panel interior"),
    ("Fixed Glass", "vidrio fijo"),
    ("tempering glass", "vidrio templado"),
    ("grammage", "gramaje"),
    ("profile", "perfil"),
    ("Two-drawer mobile cabinet", "cajonera movil de dos cajones"),
    ("contact surface uses full-grain lychee texture cowhide", "superficie de contacto en piel de vaca de flor entera con textura lichi"),
    ("non-contact surface PVC artificial leather", "superficie sin contacto en piel sintetica de PVC"),
    ("genuine leather dry rubbing fastness", "piel genuina con solidez al frote en seco"),
    ("PP+25% fiberglass integrated back frame", "estructura integrada de respaldo en PP con 25% de fibra de vidrio"),
    ("PP + 25% fiberglass integrated", "PP integrado con 25% de fibra de vidrio"),
    ("solid wood painted frame", "estructura de madera solida pintada"),
    ("diameter aluminum alloy 5-star base", "de diametro con base de cinco puntas de aleacion de aluminio"),
    ("the cabinet body uses", "el cuerpo del gabinete usa"),
    ("the table top uses", "la cubierta usa"),
    ("cabinet side panels", "paneles laterales del gabinete"),
    ("mechanical combination locks", "cerraduras mecanicas de combinacion"),
    ("standard flip-top cable box", "caja pasacables estandar con tapa abatible"),
    ("made of aluminum alloy + ABS", "fabricada en aleacion de aluminio y ABS"),
    ("paper impregnated thermosetting resins surface", "superficie de papel impregnado con resinas termoestables"),
    ("impregnated melamine paper-faced board", "tablero revestido con papel melaminico"),
    ("natural wood veneer edge banding strips", "canto de chapa de madera natural"),
    ("high-quality PVC edge banding strips", "cantos de PVC de alta calidad"),
    ("high quality PVC edge banding strips", "cantos de PVC de alta calidad"),
    ("seat cushion optional high-quality linen fabric", "cojin de asiento opcional con tela de lino de alta calidad"),
    ("full-grain Nappa cowhide", "piel de vaca napa de flor entera"),
    ("full-grain Nappa cowhid", "piel de vaca napa de flor entera"),
    ("without significant damage or peeling", "sin danos significativos ni desprendimiento"),
    ("no significant damage or peeling", "sin danos significativos ni desprendimiento"),
    ("ABS integrated back frame", "estructura integrada de respaldo en ABS"),
    ("fixed, padded armrests", "descansabrazos fijos y acolchados"),
    ("optional PVC synthetic leather", "piel sintetica de PVC opcional"),
    ("PVC synthetic leather", "piel sintetica de PVC"),
    ("Leather", "Piel"),
    ("polished aluminum alloy armrests", "descansabrazos de aleacion de aluminio pulido"),
    ("adjustable PU armrests", "descansabrazos ajustables de PU"),
    ("High-quality mechanism", "mecanismo de alta calidad"),
    ("Back Cushion", "cojin del respaldo"),
    ("load capacity", "capacidad de carga"),
    ("injection molded", "moldeado por inyeccion"),
    ("poplar plywood", "contrachapado de alamo"),
    ("Adjustable Feet", "regatones ajustables"),
    ("Nickel-plated carbon steel", "acero al carbono niquelado"),
    ("Modesty Panel", "faldon"),
    ("Seat", "Asiento"),
    ("ABS seat shell", "carcasa de asiento en ABS"),
    ("E0-grade particleboard", "tablero aglomerado grado E0"),
    ("E0 grade plywood", "contrachapado grado E0"),
    ("Tabletop Edge Banding", "canto de la cubierta"),
    ("Writing Board Adjustment", "ajuste del pizarron de escritura"),
    ("Writing board can rotate", "el pizarron de escritura puede girar"),
    ("Reception desk", "mostrador de recepcion"),
    ("Top Panel", "panel superior"),
    ("Stand panel", "panel de soporte"),
    ("Back panel", "panel posterior"),
    ("the station board uses", "el panel frontal usa"),
    ("the table legs uses", "las patas de mesa usan"),
    ("the top panel uses", "el panel superior usa"),
    ("castor wheels", "ruedas giratorias"),
    ("made of nylon", "fabricadas en nylon"),
    ("high-quality slide rail", "corredera de alta calidad"),
    ("Slide Rail", "Corredera"),
    ("Cable Box", "caja pasacables"),
    ("dual-flip cover", "tapa abatible doble"),
    ("made of aluminum alloy", "fabricada en aleacion de aluminio"),
    ("Beveling Technique", "tecnica de biselado"),
    ("panel edge", "borde del panel"),
    ("beveled at", "biselado a"),
    ("bevel distance", "distancia del bisel"),
    ("not easily damaged or detached", "resistente al dano y desprendimiento"),
    ("Finishing", "Acabado"),
...
def _clean_text(value: Any) -> str:
    ...
    visible_parts = [
        ...
        if part.strip()
        and re.match(
            r"^(?:fuente|hash\s+fuente|hash\s+fila|url|clave|coleccion)\s*:",
            part,
            flags=re.I,
        )
        is None
...
def _split_description_parts(text: str) -> list[str]:
    ...
    text = re.sub(r"\b(?:Material|Function|Process)\s+Description\s*:", " ", text, flags=re.I)
